  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex min-h-[180px] flex-col justify-between p-4">
        ...
        <Button
          asChild
          className="text-primary-600 hover:bg-primary-600 mt-4 w-fit rounded-md bg-white px-3 py-1.5 text-sm font-semibold shadow-md transition-colors hover:text-white"
          disabled={disabled}
        >
          {disabled ? (
            <p className="cursor-not-allowed opacity-60">Coming soon...</p>
          ) : (
...
AppCard.Skeleton = function AppCardSkeleton() {
  return (
